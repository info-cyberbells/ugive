...
const SkeletonLoader = () => (
  <div className="animate-pulse">
    {[1, 2, 3, 4].map((item) => (
      <div
        key={item}
        className="border-b border-gray-100 pb-4 mb-4 flex items-start p-4"
      >
...
const NotificationPage = () => {
  ...
  const currentData =
    activeTab === "notifications" ? notifications : activities;
        ...
        <div className="w-full bg-white rounded-2xl shadow-sm p-8">
          ...
          {!currentData || currentData.length === 0 ? (
            <p className="text-center text-gray-400 text-sm py-12">
              No {userRole === "super_admin" ? activeTab : "notifications"}{" "}
              found
            </p>
          ) : (
            <>
