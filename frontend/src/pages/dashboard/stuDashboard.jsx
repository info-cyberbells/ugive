        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-xl shadow-sm flex flex-col md:flex-row items-center justify-between mt-8">
            <div className="flex-1">
              ...
              <button className="mt-4 px-6 py-2 bg-[#AE9DEB]  cursor-pointer border-2 border-white text-white font-medium rounded-4xl hover:bg-violet-700 transition duration-150 shadow-lg ">
                Start Writing
              </button>
            </div>
