...
import { Bell, Plus, Edit2, Trash2, Power, X } from 'lucide-react';
                            ...
                            <div className="flex items-start justify-between">
                                <div className="flex-1">
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        <span
                                            className={`px-3 py-1 rounded-full text-xs font-medium ${notification.isActive
                                    ...
                                    <div className="flex items-center gap-4 text-sm text-gray-500">
                                        <span>
                                            <strong>Created:</strong> {formatDate(notification.createdAt)}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-2 ml-4">
                                    <button
                                        ...
                                        className={`p-2 rounded-lg transition cursor-pointer ${notification.isActive
