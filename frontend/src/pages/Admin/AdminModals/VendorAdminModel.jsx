        ...
        <div className=" p-4 sm:px-8 sm:py-6 bg-gray-50 border-t border-gray-100 flex items-center justify-end gap-3 shrink-0">
          ...
          {!isViewMode && (
            <button
              ...
              type="submit"
              disabled={isLoading}
              className="px-8 py-2.5 cursor-pointer rounded-xl text-sm font-semibold text-white bg-[#6955A5] hover:bg-[#533f8e] hover:scale-[1.02] shadow-lg shadow-indigo-100 transition-all active:scale-95 disabled:opacity-70"
            >
              {isLoading
                ? "Saving..."
                : isEditMode
...
export default VendorAdminModal;
