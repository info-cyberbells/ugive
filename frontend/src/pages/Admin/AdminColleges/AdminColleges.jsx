...
const collegeData = [
    { id: 1, name: 'Pit Hall', email: 'pithall@university.edu', streaks: '1', sentCards: "2",status: 'Active', rewardUnlocked: "Coffee" },
    { id: 2, name: 'Sheridan', email: 'shr@university.edu', streaks: '0', sentCards: "1",status: 'Inactive' },
    { id: 3, name: 'Monas', email: 'monas@university.edu', streaks: '', status: 'Active',  rewardUnlocked: "Chocolate" },
    { id: 4, name: 'U M', email: 'um@university.edu', streaks: '5', sentCards: "1",status: 'Active' },
                                    ...
                                    {data.map((college) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                                {displayData(college.email) || "N/A"}
                                            </td>
                                         

                                            {/* Phone Column */}
                                            <td className="px-6 py-4 hidden lg:table-cell whitespace-nowrap text-sm text-gray-600">
                                                {displayData(college.streaks) || "N/A"}
                                            </td>
                                            <td className="px-6 py-4 hidden lg:table-cell whitespace-nowrap text-sm text-gray-600">
                                                {displayData(college.sentCards) || "N/A"}
                                            </td>
