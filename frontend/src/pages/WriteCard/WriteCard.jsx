...
const EnvelopeSVG = () => (
    <div className="w-48 h-48 mx-auto my-8">
        <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Main Envelope Body (Purple) */}
            <path d="M20 70 H180 V160 C180 171.046 171.046 180 160 180 H40 C28.9543 180 20 171.046 20 160 V70 Z" fill="#8E44AD" />
            {/* Flap (Yellow/Orange) */}
            <path d="M20 70 L100 20 L180 70 H20 Z" fill="#F39C12" />
            {/* Card inside (White/Off-white with heart) */}
            <rect x="50" y="50" width="100" height="90" rx="8" fill="#F5F5F5" />
            {/* Heart 1 (Purple) */}
            <path d="M100 85 C90 75 70 75 70 95 C70 115 100 125 100 125 C100 125 130 115 130 95 C130 75 110 75 100 85 Z" fill="#8E44AD" />
            {/* Heart 2 (Blue) */}
            <path d="M120 70 C110 60 90 60 90 80 C90 100 120 110 120 110 C120 110 150 100 150 80 C150 60 130 60 120 70 Z" fill="#5DADE2" transform="translate(-20, 10)" />
        </svg>
    </div>
);
...
const CardForm = ({ onSubmit }) => {
    ...
    // Clear error for a specific field when typing
    ...
    if (!emailRegex.test(email)) {
        ...
        setErrors({});
        console.log("Submitting Card:", formData);
        showToast("Thank you for sending a card. ")
        onSubmit();
    };
            ...
            <div className="bg-white p-6 rounded-2xl">
                <form onSubmit={handleSubmit} className="space-y-6 pr-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label htmlFor="recipientName" className={labelClass}>Recipient's Name</label>
                            <input
                                type="text"
                                id="recipientName"
                                name="recipientName"
                        ...
                        <div>
                            <label htmlFor="recipientEmail" className={labelClass}>Recipient's Email</label>
                            <input
                                type="email"
                                id="recipientEmail"
                                name="recipientEmail"
                        ...
                        <div className="md:col-span-2">
                            <label htmlFor="collegeHouse" className={labelClass}>Recipient's College House</label>
                            <input
                                type="text"
                                id="collegeHouse"
                                name="collegeHouse"
                    ...
                    <div className="flex justify-center pt-8 relative z-10">
                        <img src={pizzaSlice} className='relative -left-30 -top-6' alt="" />
                        <button
                            type="submit"
                            className="w-full md:w-50 h-14 bg-[#6955A55A] text-gray-100 cursor-pointer font-semibold text-lg rounded-full hover:bg-[#6955A5] transition duration-300 transform hover:scale-[1.01] active:scale-[0.99]"
                        >
                            Submit
                        </button>
                    </div>
    ...
    return (
        ...
        <div className="max-w-xl text-center">
            ...
            <p className="text-[#000000] font-semibold italic mb-8 max-w-sm mx-auto">
                Note: Cards are delivered each Thursday with a Tuesday evening cutoff to allow time for printing.
            </p>
            <div className="flex justify-center">
